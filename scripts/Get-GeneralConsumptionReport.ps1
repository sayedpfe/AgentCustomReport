...
try {
    ...
    $summaryFile = Join-Path $scriptDir "GeneralConsumption_Summary_${timestamp}.csv"
    ...
    $detailFile  = Join-Path $scriptDir "GeneralConsumption_ByResource_${timestamp}.csv"
    ...
    $rawFile     = Join-Path $scriptDir "GeneralConsumption_AllEvents_${timestamp}.csv"
