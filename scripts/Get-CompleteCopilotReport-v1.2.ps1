...
function Get-DataverseData {
    ...
    foreach ($env in $environments) {
        ...
        try {
            # Get environment details from Power Platform API to find Dataverse URL
            $envDetailsUrl = "https://api.bap.microsoft.com/providers/Microsoft.BusinessAppPlatform/scopes/admin/environments/$($env.EnvironmentId)?api-version=2023-06-01"
